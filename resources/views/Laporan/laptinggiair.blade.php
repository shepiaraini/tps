...
<main id="main" class="main">
    <div>
        <h1>Laporan Deteksi Sampah</h1> <!-- Center-aligned title -->
        <div class="print-button">
        <a  href="{{ url('/cetaktinggiair') }}" class="btn btn-primary"> Cetak 
        </a>
        <div class="sensor-data-container">
            <table class="sensor-data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $i + 1 }}</td>
                        <td>{{ $ttair[$i]->created_at ?? '' }}</td>
                        <td>{{ $ttair[$i]->nilai_tinggi_air ?? '' }}</td>
                        <td>{{ $ttair[$i]->keterangan ?? '' }}</td>
                    </tr>
                    @endfor
                </tbody>
            </table>
