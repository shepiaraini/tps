      ...
      <div class="row">
        <div class="card">
            ...
            <form action="" method="get" class="row g-3">
                ...
                <div class="text">
                    <a href="#" onclick="this.href='/cetak-deteksi-sampah/' + document.getElementById('tanggal_awal').value + '/' + document.getElementById('tanggal_akhir').value" class="btn btn-primary" target="_blank">Cetak</a>
                </div>                                      
            </form>
            </div>
        </div>
