...
<main id="main" class="main">
    <div>
        <h1 style="font-family: 'Book Antiqua', serif;">Status Tempat Sampah</h1>
        <div class="sensor-data-container">
            @if ($insampah)
            <div class="sensor-data-card">
                <h2>Waktu</h2>
                <div class="value">{{ $insampah->created_at ?? '' }}</div>
            </div>
            <div class="sensor-data-card">
                <h2>Ketinggian Sampah</h2>
                <div class="value">{{ $insampah->nilai_tinggi_sampah ?? '' }}</div>
                <div class="unit">Cm</div>
            </div>
            <div class="sensor-data-card">
                <h2>Keterangan</h2>
                <div class="value">{{ $insampah->keterangan ?? '' }}</div>
            </div>
            @else
            <div class="sensor-data-card">
                <h2>No Data</h2>
